class mainMenu extends Phaser.Scene {
    ...
    preload () {
      ...
      this.load.image("flowerBG1", "assets/flowerBG1.png");
      this.load.image("flowerBG2", "assets/flowerBG2.png");
    ...
    create () {
            this.sound.stopAll();
            //sound test
            this.playsound = this.sound.add("music", {volume: 0.3});
            this.playsound.loop = true;
            if(!this.playsound.isPlaying) {
              this.playsound.play();
            }
            this.playmusic = this.sound.add("music0", {volume: 0.3});
