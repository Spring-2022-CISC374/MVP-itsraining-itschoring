class Scene0 extends Phaser.Scene {
    ...
    create () {
        ...
        var text_title1 = this.add.text(centerX - 100, 200, "It's Raining", text_style)
        var text_title2 = this.add.text(centerX - 100, 300, "It's Choring", text_style)

        var text_start = this.add.text(100, 700, 'Start', text_style)
